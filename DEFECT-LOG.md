...
| Bill proposals | 40 | Reading the place of supply (would turn the tax-split warning back into a check); bill date is still supplied by the caller |
| Word positions / columns | 14 | Zepto's rate-in-an-amount-column; captions with fewer than two recognised column words |
