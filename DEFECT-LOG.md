...
| LLM extraction | 26 | **Never called against a real API** — the sandbox has no route to api.deepseek.com (EHOSTUNREACH). `scripts/llm-extraction-probe.ts` measures it; unrun |
